...
<#if settings.auto_night_mode>
    <script src="//cdn.jsdelivr.net/gh/hiparker/halo-comment-normal@v1.0.0/dist/halo-comment.min.js"></script>
<#else>
    <script src="${options.comment_internal_plugin_js!'//cdn.jsdelivr.net/gh/hiparker/halo-comment-normal@v1.0.0/dist/halo-comment.min.js'}"></script>
</#if>

<#if settings.music_plugins=true>
    <!-- require APlayer -->
...
<script type="text/javascript">
    ...
    console.log("%c Github %c", "background:#24272A; color:#ffffff", "", "https://github.com/hiparker");
